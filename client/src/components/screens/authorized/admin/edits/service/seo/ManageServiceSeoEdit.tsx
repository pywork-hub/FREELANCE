...
import type { IManageServiceSeoEdit } from './interface/manage-service-seo-edit.interface'

const ManageServiceSeoEdit: FC<IManageServiceSeoEdit> = ({
	registerInput,
	resetField,
	control,
	errors,
	...
	return (
		<div className={globalStyles.seo}>
			...
			<div className={globalStyles.toggles}>
				...
				>
					{isShow.seo ? 'Убрать сео' : 'Добавить сео'}
				</Button>
				{isShow.seo && (
					<Button
						type="button"
...
export default ManageServiceSeoEdit
